(module
 ...
 (data (i32.const 56) "\06\00\00\00O\00p\00e\00n\00e\00d\00")
 (data (i32.const 72) "\0c\00\00\00H\00e\00l\00l\00o\00 \00s\00e\00r\00v\00e\00r\00")
 (data (i32.const 104) "\06\00\00\00C\00l\00o\00s\00e\00d\00")
 (data (i32.const 120) "\n\00\00\00R\00e\00c\00e\00i\00v\00e\00d\00:\00 \00")
 (data (i32.const 144) "\04\00\00\00n\00u\00l\00l\00")
 (data (i32.const 160) "\0e\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s\00")
 (data (i32.const 192) "\00\00\00\00")
 (data (i32.const 200) "\17\00\00\00~\00l\00i\00b\00/\00i\00n\00t\00e\00r\00n\00a\00l\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s\00")
 ...
 (func $~lib/allocator/tlsf/Root#set:tailRef (; 10 ;) (type $iiv) (param $0 i32) (param $1 i32)
 ...
 (func $~lib/allocator/tlsf/Root#setSLMap (; 11 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
 ...
 (func $~lib/allocator/tlsf/Root#setHead (; 12 ;) (type $iiiiv) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
 ...
 (func $~lib/allocator/tlsf/Root#get:tailRef (; 13 ;) (type $ii) (param $0 i32) (result i32)
 ...
 (func $~lib/allocator/tlsf/Root#setJump (; 20 ;) (type $iiiv) (param $0 i32) (param $1 i32) (param $2 i32)
 ...
 (func $~lib/allocator/tlsf/ffs<u32> (; 24 ;) (type $ii) (param $0 i32) (result i32)
  ;;@ ~lib/allocator/tlsf.ts:422:2
  (if
   (i32.eqz
    ;;@ ~lib/allocator/tlsf.ts:422:9
 ...
 (func $~lib/allocator/tlsf/Root#search (; 25 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/allocator/tlsf/Root#use (; 26 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/allocator/tlsf/__memory_allocate (; 27 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/memory/memory.allocate (; 28 ;) (type $ii) (param $0 i32) (result i32)
  ;;@ ~lib/memory.ts:41:4
  (return
   ;;@ ~lib/memory.ts:41:45
 ...
 (func $~lib/allocator/tlsf/__memory_free (; 29 ;) (type $iv) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/allocator/tlsf/__memory_reset (; 31 ;) (type $v)
  ;;@ ~lib/allocator/tlsf.ts:502:2
  (unreachable)
 )
 ...
 (func $assembly/index/websocketOnOpen (; 33 ;) (type $v)
 ...
 (func $assembly/index/websocketOnClose (; 34 ;) (type $v)
 ...
 (func $~lib/internal/string/copyUnsafe (; 36 ;) (type $iiiiiv) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $~lib/string/String#concat (; 37 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/index/websocketOnMessage (; 39 ;) (type $iv) (param $0 i32)
  ;;@ assembly/index.ts:23:12
  (call $assembly/index/console.log
   ;;@ assembly/index.ts:23:16
